...
int main()
{
	...
	Shader shaderProgram("default1.vert", "default.frag");
	...
	glm::vec4 lightColor = glm::vec4(0.0f, 0.7f, 1.0f, 1.0f);
	...
	Texture specularTiling("specular_tiling.png", GL_TEXTURE_2D, GL_TEXTURE1, GL_RGB, GL_UNSIGNED_BYTE);
